...
\hspace{1cm} \verb+/net/cremi/rnamyst/etudiants/pmg/opencl/+. \\
...
\section{Effet de la divergence sur les performances}
...
pas le même calcul que l'autre. 

\begin{enumerate}
\item  Modifiez le noyau \verb#vector.cl#  de sorte que chaque thread exécute 10 
fois la multiplication pour bien mettre en valeur le phénomène. 

\item Dupliquer le répertoire afin de produire une version où les
  threads d'indice pair calculent 10 fois une
  multplication par le paramètre \verb#k#, les autres multipliant par
  \verb#3.14#.

\item Faire une deuxième version 
où les groupes d'indice pair calculent les 10 multplications par \verb#k#, les
autres celles par \verb#3.14#. 

\item Faire une troisième version où les threads dont le numéro a son
  ième bit à 1 (\verb#(index >>i)&1#) calculent les 10 multiplications
  par \verb#k#, les autres celles par \verb#3.14#. Quelle est la plus
  petite valeur de \verb#i# pour la quelle on observe de bonnes
  performances ?
\end{enumerate}
